 ...
 * --- Generated at 19 août 2020 à 00:16:34                     ---
 * ----------------------------------------------------------------
 *  
 * [y] hybris Platform
...
public abstract class GeneratedMerchandiseCoreManager extends Extension
{
	...
	public Author createAuthor(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( MerchandiseCoreConstants.TC.AUTHOR );
	...
	public Book createBook(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( MerchandiseCoreConstants.TC.BOOK );
